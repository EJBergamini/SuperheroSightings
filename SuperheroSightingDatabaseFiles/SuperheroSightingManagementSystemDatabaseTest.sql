DROP DATABASE IF EXISTS SuperheroSightingManagementSystemDatabaseTest;

CREATE DATABASE SuperheroSightingManagementSystemDatabaseTest;

USE SuperheroSightingManagementSystemDatabaseTest;
