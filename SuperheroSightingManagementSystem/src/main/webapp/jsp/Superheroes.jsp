...
<html>
    ...
    <header>
        <div id="heading"><h1>Superheroes</h1></div>
    </header>
    <hr>
    <body>
        <div class="container-fluid"> 
            <div class="navbar">
                <ul class="nav nav-tabs">
                    ...
                    <li role="presentation" class="active tabs"><a href="${pageContext.request.contextPath}/jsp/Superheroes.jsp">Superheroes</a></li>
        ...
        <div class="container-fluid jumbotron">
            <h3 id="jumboTitle"><p>- Superheroes -</p></h3>
            <br>
            <h4><p>Below you can see a list of all superheroes. If there are many superheroes you can click the next button or page number. To return to the last page click the last button or the page number. On the right panel you can see details for any superhero you click on.</p></h4>
        </div>  
        <hr>
            ...
            <div class="col-xs-7" id="displaySightings">
                <table class="table table-striped table-hover table-responsive" id="sightingOutput">
                    ...
                    <tr scope="row">
                        ...
                        <td>
                            <c:out value="${svm.sighting.sightingDate.toLocalDate()}"/>
                        </td>                    
                        <td>
